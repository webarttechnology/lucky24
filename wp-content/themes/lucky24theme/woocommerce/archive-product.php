...
?>
<section class="contact-banner-page" style="background-image: url(<?php echo get_field('shop_banner',6103); ?>);">
<?php }
else
{
	?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="contact-text text-center">
                    <h1 data-aos="fade-down" data-aos-duration="1000">Event Merchandise</h1>
                </div>
            </div>
        </div>
    </div>
