	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'subtitle'   => __( 'Select an accordion theme style.To unlock 16+ Premium Accordion Themes,  <a href="https://easyaccordion.io/pricing/?ref=1" target="_blank"> <b>Upgrade To Pro!</b> </a>', 'easy-accordion-free' ),
				'desc'       => __( 'Check out <a href="https://easyaccordion.io/all-accordion-themes/"  target="_blank"><b>16+ Premium Pre-designed</b></a> Accordion Themes!', 'easy-accordion-free' ),
				'options'    => array(
					'sp-ea-one' => array(
	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'content' => __( 'To unlock the more settings for <b>Accordion Item Title & Description, Animation, Ajax Pagination</b>, <a href="https://easyaccordion.io/pricing/?ref=1" target="_blank"><b>Upgrade To Pro!</b></a>', 'easy-accordion-free' ),
			),
			array(
				'type'    => 'subheading',
...
SP_EAP::createSection(
	...
	array(
		...
		'fields'          => array(
			array(
				'type'    => 'notice',
				'content' => __( 'To unlock These Typography (940+ Google Fonts) options,<a href="https://easyaccordion.io/pricing/?ref=1" target="_blank"> <b>Upgrade To Pro!</b></a> P.S. Note: The color fields work in the lite version.', 'easy-accordion-free' ),
			),
			array(
